...
namespace FirstIssue.WebApp.Controllers.WebApi
{
    ...
    {                
        ...
        {
            string itunesDecodedReceipt = Encoding.UTF8.GetString(
                ReceiptVerificationService.ConvertAppStoreTokenToBytes(receipt.Replace("<", string.Empty).Replace(">", string.Empty))).Trim();
