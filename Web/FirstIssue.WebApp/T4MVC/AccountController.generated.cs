...
namespace FirstIssue.WebApp.Controllers
{
    public partial class AccountController
    {
        ...
        public class ViewsClass
        {
            ...
            public class _ViewNamesClass
            {
                public readonly string ForgotPassword = "ForgotPassword";
                public readonly string Login = "Login";
                public readonly string LoginWithExternalProviderPartial = "LoginWithExternalProviderPartial";
                public readonly string Register = "Register";
                public readonly string ResetPassword = "ResetPassword";
            }
            public readonly string ForgotPassword = "~/Views/Account/ForgotPassword.cshtml";
            public readonly string Login = "~/Views/Account/Login.cshtml";
            public readonly string LoginWithExternalProviderPartial = "~/Views/Account/LoginWithExternalProviderPartial.cshtml";
    ...
    public class T4MVC_AccountController : FirstIssue.WebApp.Controllers.AccountController
    {
        ...
        public override System.Web.Mvc.ActionResult Login(FirstIssue.WebApp.ViewModels.Account.LoginViewModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        public override System.Web.Mvc.ActionResult ExternalLoginConfirmation(FirstIssue.WebApp.ViewModels.Account.RegisterExternalLoginViewModel model, string returnUrl)
        {
        ...
        public override System.Web.Mvc.ActionResult Manage(FirstIssue.WebApp.Controllers.ManageMessageId? message)
        {
        ...
        public override System.Web.Mvc.ActionResult Manage(FirstIssue.WebApp.ViewModels.Account.LocalPasswordViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Manage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            return callInfo;
        ...
        public override System.Web.Mvc.ActionResult Register(FirstIssue.WebApp.ViewModels.Account.RegisterViewModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
            return callInfo;
